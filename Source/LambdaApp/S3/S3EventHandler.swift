...
public extension LambdaApp {
    ...
    func addS3Handler(_ handlerKey: CustomStringConvertible, _ handler: S3EventHandler) {
        self.addHandler(handlerKey, handler)
    }
    
    func addS3Handler(_ handlerKey: CustomStringConvertible, _ handler: @escaping S3EventHandler.Handler) {
        self.addS3Handler(handlerKey, S3EventHandler(handler))
    }
    
    func addS3BodyHandler(_ handlerKey: CustomStringConvertible, _ handler: @escaping S3EventHandler.BodyHandler) {
